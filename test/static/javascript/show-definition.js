...
function flip_all(btn_id, element_suffix) {
    ...
    for (var i = 1; i <= words_cnt; ++i) {
        element_hide_control(element_suffix + i, show);
    }
}
...
function export_words() {
    ...
    var export_text = "";
    for (var i = 1; i <= words_cnt; ++i) {
        export_text += export_word_to_str(format, i);
    }
